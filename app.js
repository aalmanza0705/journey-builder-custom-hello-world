...
var APIKeys = {
    appId           : 'a46b8786-4c91-40b4-bbaf-fcc90bfcc2e2',
    clientId        : '96m07r5qeawu0ykaneitsy2n',
    clientSecret    : '63QihVdkDpUREkxMTJh6yU2g',
...
app.post('/fireEvent/:type', function( req, res ) {
    var data = req.body;
    var triggerIdFromAppExtensionInAppCenter = 'jb-hello-world-trigger-Angel';
